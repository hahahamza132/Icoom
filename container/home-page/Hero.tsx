...
export default function Hero() {
	return (
		<section className="relative w-full min-h-screen bg-primary overflow-hidden">
			...
			<div className="absolute inset-0 bg-[linear-gradient(rgba(0,102,204,0.0001)_1px,transparent_1px),linear-gradient(90deg,rgba(0,102,204,0.01)_1px,transparent_1px)] bg-[size:60px_60px]"></div>
